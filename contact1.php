        ...
        <div class="row justify-content-center mb-3">
            <div class="col-md-6 p-4 left-column">
                ...
                <ul class="list-unstyled">
                    <li class="mb-3"><a href="https://bsky.app/alex-maundrell.bsky.social" target="_blank" class="text-decoration-none text-white"><i class="fa-brands fa-square-bluesky my-font-size"></i> <span class="fs-4">Bluesky: @alex-maundrell.bsky.social</span></a></li>
                    <li class="mb-3"><a href="https://www.linkedin.com/in/alexander-maundrell" target="_blank" class="text-decoration-none text-white"><i class="fa-brands fa-linkedin my-font-size"></i> <span class="fs-4">LinkedIn: alexander-maundrell</span></a></li>
                    <li class="mb-3"><a href="#" id="copy-email" class="text-decoration-none text-white"><i class="fa-solid fa-envelope my-font-size"></i> <span class="fs-4">info@alex-maundrell.dev</span> </a><i class="fa-solid fa-copy my-font-size-2"></i></li>
                </ul>
            </div>
...
<div class="overlay">
    <div class="overlay-content">
        <div class="card">
            <div class="card-header">Message Sent Successfully!</div>
...
<?php
// Clear the session messages so they don't persist on refresh
